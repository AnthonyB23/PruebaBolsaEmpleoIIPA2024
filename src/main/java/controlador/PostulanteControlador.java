...
public class PostulanteControlador {
    ...
    public void insertarPostulante(PostulanteModelo p) {
        ...
        try {//LANZAR TESTEAR UN CONJUNTO DE CÓDIGO 
            String sentenciaSQL = "call insertar_postulante('" + p.getNombres() + "','" + p.getApellidos() + "','" + p.getCedula() + "','" + p.getDireccion() + "','" + p.getCorreoElectronico() + "','" + p.getFechaNacimiento() + "','" + p.getEspecialidad() + "','" + p.getExperiencia() + "','" + p.getEstado() + "');";
